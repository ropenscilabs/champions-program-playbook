...
As the @sec-comm-plan-recruitment details the communication plan for the _Recruiting Champions and mentors_ phase and how we use the different media, in the following sessions we describe the communication plan and tools for the rest of the phase of the Champions Program.
