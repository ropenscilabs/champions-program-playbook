...
The @sec-comm-plan-recruitment details the communication plan for the _Recruiting champions and mentors_ phase and how we use the differents media. The following sessions describe the communication plan and tools for the rest of the phase of the Champions Program.

### Selection and onboarding

At this stage the external communication informs about the results of the call, e.g. the number of applications received.  It also shares the program schedule and the activities that are being carried out.
...
All blog post are shared on the monthly newsletter. 

On social media we use a multipost strategy:
