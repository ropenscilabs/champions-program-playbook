...
The communication of the program includes two aspects: the internal communication of the program, with its participants and the external communication, to shared and inform the community in general. 
...
* The first step is to inform about the results of the call, e.g. the number of applications received, the type of project and from where are the applicants.  
...
All blog post are shared on the monthly newsletter and in some Slack workspaces related with the program.

* The second step is to update the Champions Program and rOpenSci Webpage:
...
For the first cohort we write a series of blog post
