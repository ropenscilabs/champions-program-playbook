...
7. Welcome the attendees and mention we will record the session.  All the material is only shared with the cohort. 
...
9. When the vide recording is ready, create the folder for the session in the google drive for the cohort and upload all the necessary files.  Edit the video and summary with timestamp if neccesary.

10. Then send the email and post the message in Slack sharing the following materials:

  - Slides.
  - Video.
  - Video summary with timestamp (this is generated with Zoom tools).  This was a request from champions to check the material without the need to watch all the video.  
  - Automatic Subtitles. 
  - Chat.
  - Transcript.
  - Shared notes.
