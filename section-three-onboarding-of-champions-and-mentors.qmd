...
meeting. For the second cohort the first one-on-one meeting is organizer for the mentor. 
...
Selected mentors recibe a email with the notification and a series of steps on how to get started. Here is a template of the message.
