...
After the application deadline, the community manager with other team member review *champions* and *mentors* applications to check for completion and elegibility.  Those application that are not complete or the project is not on the scope of the champions program are remove from the list. 
...
### Step 4: Meeting to discuss mentors applicants and final selection
...
### Step 5: Inform mentors applicants (3 weeks)
...
### Step 7: Selection team reviews their assigned mentors applicants (2 weeks)
