...
-   Champions application final questions. These are the questions in the application form. Available in [English](https://ropensci.org/champions/files/champions_template/) and [Spanish]((https://ropensci.org/champions/files/champions_template_es/)).

-   After the first year application, we create [Frequently Asked Question (FAQs) for Champions](https://ropensci.org/champions/programdetails_2023/#frequently-asked-questions). These FAQs improved response time to interested people's queries.

    ::: callout-note
    [Application form template](https://docs.google.com/document/d/18V38IdipJXNL8w714Xdoj8XHd9j-mr8aDQl0TqOIAEg/edit#heading=h.d3uqayuakf9e) in google doc format for the 2022-23 application call. Preserved for archival reasons. Access only by the rOpenSci Champions Program Team. All information is available with open license and up to date on the Champions Program web site and this playbook.
    :::
...
-   Mentor application final list of questions. These are the question in the application form. Available in [English](https://ropensci.org/champions/files/mentors_champions_template/) and [Spanish](https://ropensci.org/champions/files/mentors_champions_template_es/).
...
-   After the first year we also create [Frequently Asked Questions for Mentors](https://ropensci.org/champions/programdetailsmentors_2023/#frequently-asked-questions)
    ...
    ::: callout-note
    [Application form template](https://docs.google.com/document/d/1HdyQW-xIbj21UxjEEKl9-XDyaDXjtNqbnu-MBhk1ejA/) in google doc format for the 2022-23 application call. Preserved for archival reasons. Access only by the rOpenSci Champions Program Team. All information is available with open license and up to date on the Champions Program web site and this playbook.
    :::
...
-   Champions and mentors information including eligibility criteria, benefits of taking part, expectations, [timeline for the program](https://ropensci.org/champions/#program-2023-2024-timeline), [FAQs for champions](https://ropensci.org/champions/programdetails_2023/#frequently-asked-questions) and [for Mentors](https://ropensci.org/champions/programdetailsmentors_2023/#frequently-asked-questions), and templates.
...
![Announcement of the Champions Program and Reminder of the last day for send the application](images/social-media-examples-1.jpg) ![Post with important dates and a community partner post sharing the second cohort call](images/social-media-examples-2.jpg)
